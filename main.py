...
def parse(args=None):
    ...
    parser.add_argument('--target_attr', dest='target_attr', default="Mustache", help='Target attribute')
    ...
    parser.add_argument('--sample_interval', dest='sample_interval', type=int, default=1, help='# of iteration between evaluations') #1000
    parser.add_argument('--gpu', dest='gpu', action='store_true')
    parser.add_argument('--multi_gpu', dest='multi_gpu', action='store_true')
    parser.add_argument('--experiment_name', dest='experiment_name', default=datetime.datetime.now().strftime("%I%M%p%B%d%Y"))
