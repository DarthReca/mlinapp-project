...
python train.py --training_approach="specific" --epochs=30 --batch_size=128 --num_workers=4 --indices_path="data/chosen_indices_eyeglasses_smaller.npy" --experiment_name="dg3 freeze 4 rec 50" --target_attr="Eyeglasses" --dg_ratio=3 --upload_weights --max_time "00:01:00:00" --freeze_layers 4 --mode wgan --lambda_1 50 --use_alternate_dataset